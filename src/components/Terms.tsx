...
import { SERVICETERMSCONSENT, PERSONALDATACONSENT } from "src/constants/terms";
...
export default function Terms({ setPageIndex }: any) {
  ...
  return (
    <div className=" mx-auto inline-flex justify-center items-center px-8">
        ...
        <div className="mx-12 flex flex-col space-y-4 text-xs text-[#A9A9A9] mb-11">
          <div className="flex justify-between">
            ...
            <Image
              ...
              onClick={() => {
                setShowModal(true)
                setModalContent({ title: '서비스 이용약관 동의', content: SERVICETERMSCONSENT })
              }}
            />
          </div>
          <div className="flex justify-between">
            ...
            <Image
              ...
              onClick={() => {
                setShowModal(true)
                setModalContent({ title: '개인정보 수집 및 이용동의', content: PERSONALDATACONSENT })
              }}
            />
            <div>
            </div>
      ...
      <SignModal showModal={showModal} setShowModal={setShowModal} title={modalContent.title} content={modalContent.content} />
    </div>
  );
}
